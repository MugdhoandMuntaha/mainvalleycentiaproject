...
export default async function PrivacyPage() {
    const policy = await getSiteSetting('policy_privacy') as { content: string } | null;
    const content = policy?.content || 'Privacy Policy content is currently empty.';
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#2e7d32', fontSize: '14px', fontWeight: 600 }}>
                        <Eye size={16} />
                        <span>Committed to absolute data transparency</span>
                    </div>
                </div>
            </div>
        </div>
