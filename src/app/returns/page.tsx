...
export default async function ReturnsPage() {
    const policy = await getSiteSetting('policy_returns') as { content: string } | null;
    const content = policy?.content || 'Return & Refund Policy content is currently empty.';
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#2e7d32', fontSize: '14px', fontWeight: 600 }}>
                        <ShieldCheck size={16} />
                        <span>Hassle-free return and refund guarantee</span>
                    </div>
                </div>
            </div>
        </div>
