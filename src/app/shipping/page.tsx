...
export default async function ShippingPage() {
    const policy = await getSiteSetting('policy_delivery') as { content: string } | null;
    const content = policy?.content || 'Delivery Policy content is currently empty.';
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#2e7d32', fontSize: '14px', fontWeight: 600 }}>
                        <HelpCircle size={16} />
                        <span>Have questions? Contact our 24/7 Support</span>
                    </div>
                </div>
            </div>
        </div>
